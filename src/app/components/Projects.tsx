...
export default function Projects() {
  return (
    ...
    >
      <h1 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground pb-2 sm:pb-4 text-center">
        PROJECTS
      </h1>
      <p className="text-center text-tertiary text-base sm:text-lg mb-12 sm:mb-16">
