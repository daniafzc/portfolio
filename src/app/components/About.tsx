...
const About = () => {
  return (
    <div
      ...
      data-aos-delay="400"
      id="about"
      className="relative h-full py-12 sm:py-16 mx-4 sm:m-10 rounded-3xl sm:rounded-4xl text-foreground items-center card"
    >
      <div className="w-[90%] sm:w-[85%] mx-auto grid grid-cols-1 md:grid-cols-[55%_40%] gap-8 my-6 sm:my-10">
        ...
        <div className="text-left">
          <div className="w-30 py-1 bg-sky-100 border border-sky-200 text-center rounded-full mb-6 sm:mb-10">
            <h2 className="text-sm sm:text-medium text-tertiary">ABOUT ME</h2>
          </div>

          <h1 className="text-left text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-wide text-foreground">
            <span className="font-heading font-black bg-transparent text-transparent bg-gradient-to-r from-primary to-foreground bg-clip-text">
              Hello, I'm
            </span>{" "}
            <br /> Dania Hafiza
          </h1>
          ...
          <div className="flex flex-row flex-wrap gap-3 sm:gap-4 mt-5 sm:mt-6">
            <Link
              href="/cv.pdf"
              download
              className="px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg cursor-pointer rounded-full bg-primary hover:bg-[#2a8fc6] transition-all duration-300 text-white flex items-center space-x-2 shadow-md shadow-sky-300/40"
            >
            ...
            <Link
              href="#projects"
              className="px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg cursor-pointer rounded-full border border-sky-200 bg-sky-50 hover:bg-[#FFD301] hover:border-[#FFD301] transition-all duration-300 text-foreground flex items-center space-x-2"
            >
